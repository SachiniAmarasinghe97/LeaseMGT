...
export default function Home() {
    ...
    return (
      <><div className="home-page"></div><h1>Policy Create Form</h1><Button
        ...
        >
            ...
            </div><Modal show={showModal} onHide={handleCloseModal} backdrop="static">
                        ...
                        <Form>
                            ...
                            <Form.Group controlId="formPolicyFullName" className="form-group">
                                ...
                                <Form.Control
                                    ...
                                    value={newPolicy.fullName}
                                    onChange={(e) => setNewPolicy({ ...newPolicy, fullName: e.target.value })}
                                    required />
                            </Form.Group>
            ...
            </Modal><Modal show={showLeaseModal} onHide={handleCloseLeaseModal} backdrop="static">
                <Modal.Header closeButton>
